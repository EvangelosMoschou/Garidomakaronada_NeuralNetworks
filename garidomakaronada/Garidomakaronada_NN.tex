...
{\Large Συλλογή Παλαιών Θεμάτων}\\[2em]
\href{https://github.com/EvangelosMoschou/Garidomakaronada_NeuralNetworks}{\texttt{https://github.com/EvangelosMoschou/Garidomakaronada\_NeuralNetworks}}\\[3em]
\end{center}
...
{\footnotesize \textbf{Disclaimer:} Οι παρούσες λύσεις και εκφωνήσεις ενδέχεται να περιέχουν λάθη.}
\end{center}
...
\item Ποια είναι η κύρια διαφορά μεταξύ supervised και unsupervised learning;
...
\item Η συνάρτηση ενεργοποίησης ReLU ορίζεται ως:
\begin{enumerate}[label=\alph*)]
...
\item Ποιο από τα παρακάτω είναι πλεονέκτημα της βαθιάς μάθησης;
\begin{enumerate}[label=\alph*)]
...
\item Το dropout είναι τεχνική για:
\begin{enumerate}[label=\alph*)]
...
\item Σε ένα Convolutional Neural Network, η λειτουργία pooling χρησιμοποιείται για:
\begin{enumerate}[label=\alph*)]
...
\item Ποια συνάρτηση κόστους χρησιμοποιείται συνήθως για προβλήματα ταξινόμησης;
\begin{enumerate}[label=\alph*)]
...
\item Το vanishing gradient πρόβλημα εμφανίζεται κυρίως όταν:
\begin{enumerate}[label=\alph*)]
...
\item Τι κάνει ο αλγόριθμος back-propagation;
\begin{enumerate}[label=\alph*)]
...
\item Ο κανόνας Hebb μάθησης δηλώνει ότι:
\begin{enumerate}[label=\alph*)]
...
\item Για n κλάσεις, πόσα SVM χρειάζονται στην προσέγγιση one-vs-one;
\begin{enumerate}[label=\alph*)]
\item $n$
\item $n-1$
...
\item Ο πολυωνυμικός πυρήνας 2ου βαθμού είναι:
\begin{enumerate}[label=\alph*)]
...
\item Ο Hessian πίνακας στο SVM optimization έχει διάσταση:
\begin{enumerate}[label=\alph*)]
...
\item Σε mini-batch SGD με batch size 30 και 8000 δεδομένα, πόσες ενημερώσεις βαρών γίνονται σε 1 εποχή;
\begin{enumerate}[label=\alph*)]
\item 30
\item 8000
...
\item Για 8 εποχές με τα παραπάνω δεδομένα, πόσες συνολικές ενημερώσεις γίνονται;
\begin{enumerate}[label=\alph*)]
\item 2000
...
\item Ο κανόνας Delta learning ενημερώνει τα βάρη σύμφωνα με:
\begin{enumerate}[label=\alph*)]
...
\item Η υπερβολική εφαπτομένη (tanh) ως συνάρτηση ενεργοποίησης έχει παράγωγο:
\begin{enumerate}[label=\alph*)]
...
\item Το leave-one-out error estimate για SVM με 5 support vectors σε 80 training examples είναι περίπου:
\begin{enumerate}[label=\alph*)]
\item 0.5
\item 0.1
...
%========================================================================
\section*{Άσκηση 1: Αλγόριθμος Πίσω-Διάδοσης (Backpropagation)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 3: Κανόνας Δέλτα}
%========================================================================
...
%========================================================================
\section*{Άσκηση 4: Γραμμικά SVMs}
%========================================================================
...
%========================================================================
\section*{Άσκηση 5: SVMs με Πυρήνες}
%========================================================================
...
%========================================================================
\section*{Άσκηση 9: Συναρτήσεις Ενεργοποίησης}
%========================================================================
...
%========================================================================
\section*{Άσκηση 10: Υπερ-εκπαίδευση και Κανονικοποίηση}
%========================================================================
...
%========================================================================
\section*{Άσκηση 11: Κανόνας Perceptron (βήμα-βήμα)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 12: ADALINE (Widrow--Hoff) vs Perceptron}
%========================================================================
...
%========================================================================
\section*{Άσκηση 13: Ορμή (Momentum) στην ενημέρωση βάρους}
%========================================================================
...
%========================================================================
\section*{Άσκηση 14: Δίκτυο RBF (1D παλινδρόμηση)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 15: ICA -- Whitening}
%========================================================================
...
%========================================================================
\section*{Άσκηση 16: FastICA -- μία επανάληψη fixed-point}
%========================================================================
...
%========================================================================
\section*{Άσκηση 17: Cross-Validation (υπολογισμός)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 18: Cascade-Correlation (λογική βημάτων)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 19: Πρακτικό SVM -- Scaling και επιλογή $C,\gamma$}
%========================================================================
...
%========================================================================
\section*{Άσκηση 20: Softmax και Cross-Entropy (gradient)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 21: Adam (ένα update)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 22: ICA και μη-Γκαουσιανότητα (kurtosis)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 23: Αλγόριθμος Πίσω-Διάδοσης (Δίκτυο 4 νευρώνων)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 24: Διαγώνιο SVM (5 σημεία)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 25: Διαγώνιο SVM (11 σημεία)}
%========================================================================
...
%========================================================================
\section*{Άσκηση 26: SVM με μη-τετριμμένη κατεύθυνση}
%========================================================================
...
\begin{enumerate}
\item \textbf{Περιγράψτε τη δομή ενός τεχνητού νευρώνα (perceptron) και εξηγήστε τον ρόλο κάθε συνιστώσας.}
...
\item \textbf{Ποια είναι η διαφορά μεταξύ supervised και unsupervised learning; Δώστε ένα παράδειγμα αλγορίθμου για κάθε κατηγορία.}
...
\item \textbf{Περιγράψτε τρεις διαφορετικές συναρτήσεις ενεργοποίησης και τα πλεονεκτήματα/μειονεκτήματα της καθεμίας.}
...
\item \textbf{Τι είναι το Universal Approximation Theorem και ποιες είναι οι προϋποθέσεις του;}
...
\begin{enumerate}
\item \textbf{Εξηγήστε τον κανόνα μάθησης Hebb και δώστε τον μαθηματικό τύπο. Τι μαθαίνει ένας νευρώνας με Hebbian learning;}
...
\item \textbf{Ποια είναι η διαφορά μεταξύ του κανόνα Δέλτα (Delta Rule) και του Backpropagation;}
...
\item \textbf{Τι είναι το vanishing gradient problem και πώς μπορεί να αντιμετωπιστεί;}
...
\item \textbf{Εξηγήστε τη διαφορά μεταξύ batch, mini-batch και stochastic gradient descent.}
...
\begin{enumerate}
\item \textbf{Τι είναι overfitting και underfitting; Πώς μπορούμε να τα αναγνωρίσουμε;}
...
\item \textbf{Περιγράψτε τέσσερις τεχνικές regularization στα νευρωνικά δίκτυα.}
...
\item \textbf{Τι είναι το Batch Normalization και γιατί βοηθάει την εκπαίδευση;}
...
\begin{enumerate}
\item \textbf{Εξηγήστε τη λειτουργία ενός convolutional layer. Τι είναι τα filters/kernels;}
...
\item \textbf{Τι είναι το pooling layer και ποιος είναι ο σκοπός του;}
...
\item \textbf{Εξηγήστε τους όρους: stride, padding, receptive field.}
...
\begin{enumerate}
\item \textbf{Γιατί τα RNNs είναι κατάλληλα για ακολουθιακά δεδομένα; Περιγράψτε τη βασική αρχιτεκτονική.}
...
\item \textbf{Τι πρόβλημα λύνουν οι αρχιτεκτονικές LSTM και GRU;}
...
\begin{enumerate}
\item \textbf{Τι είναι ένας Autoencoder και ποια είναι η δομή του;}
...
\item \textbf{Ποιες είναι οι εφαρμογές των Autoencoders;}
...
\begin{enumerate}
\item \textbf{Εξηγήστε την έννοια του margin στα SVMs και γιατί θέλουμε να το μεγιστοποιήσουμε.}
...
\item \textbf{Τι είναι το kernel trick και γιατί είναι χρήσιμο;}
...
\item \textbf{Ποια είναι η διαφορά μεταξύ hard-margin και soft-margin SVM;}
...
\begin{enumerate}
\item \textbf{Τι είναι η ICA και σε τι διαφέρει από την PCA;}
...
\item \textbf{Δώστε ένα παράδειγμα εφαρμογής της ICA (``cocktail party problem'').}
